...
def _generate_synthetic_scenario(scenario):
    ...
    defs = {
        ...
        "warning": [
            (50.0,  0.5,  0.1, 0.05, "WRN"),
            (80.0,  2.0,  0.3, 0.08, "WRN"),
            (30.0,  0.08, 0.0, 0.03, "WRN"),
            (200.0, 40.0, 0.0, 0.2,  "WRN"),
        ],
        "critical": [
            (20.0,  0.02, 0.01, 0.02, "CRT"),
            (40.0,  0.05, 0.0,  0.04, "CRT"),
            (60.0,  0.3,  0.1,  0.06, "CRT"),
            (100.0, 10.0, 0.0,  0.1,  "CRT"),
        ],
        "mixed": [
            (25.0,  0.03, 0.01, 0.025, "MIX"),
            (50.0,  0.4,  0.1,  0.05,  "MIX"),
            (80.0,  3.0,  0.5,  0.08,  "MIX"),
            (40.0,  0.08, 0.02, 0.04,  "MIX"),
